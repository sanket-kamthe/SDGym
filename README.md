...
for non-temporal tabular data. SDGym is based on the paper
[Modeling Tabular data using Conditional GAN](https://arxiv.org/abs/1907.00503),
and the project is part of the [Data to AI Laboratory](https://dai.lids.mit.edu/) at MIT.
...
consist of making the synthesizer generate different datasets and evaluate the synthesized data against  this datasets though a series of tasks
...
If your synthesizer implement a different interface, you can wrap in a function like this:
